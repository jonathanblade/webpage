export default {
  ...
  "bachelor.diploma.title":
    "Влияние солнечных вспышек на ионосферу Земли в 24-ом цикле солнечной активности",
  "master.diploma.title":
    "Оценка точности позиционирования GPS при естественных и искусственных возмущениях ионосферы",
  "phd.diploma.title":
    "Влияние естественной и антропогенной ионосферной возмущенности на точность прецизионного позиционирования ГНСС",
  "istp": "ИСЗФ СО РАН",
